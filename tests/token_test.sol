...
contract testSuite {
    ...
    function test_mint_burn() public {
        ...
        XZ.mint(500000 ether);
        Assert.equal(XZ.balanceOf(address(this)),  500000 ether, "Amount is not 500000 token;");
        ...
        XZ.mint(500000 ether);
        Assert.equal(XZ.balanceOf(address(this)),  1000000 ether, "Amount is not 1000000 token;");

        // Burn all tokens
        XZ.burn(1000000 ether);
